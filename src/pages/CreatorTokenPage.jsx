...
const CreatorDashboardPage = () => {
  ...
  // États pour les modals Créer/Importer jeton
  ...
  const refreshTokenData = async () => {
    ...
    try {
      ...
      const walletAddress = wallet.getAddress();
      const updatedProfile = await ProfileService.getProfileByOwner(walletAddress);
  ...
  const handleToggleVisibility = async () => {
    ...
    try {
      ...
      await ProfileService.updateTokenMetadata(walletAddress, tokenId, {
  ...
  const handleSaveImage = async () => {
    ...
    try {
      ...
      const walletAddress = wallet.getAddress();
      await ProfileService.updateTokenImage(walletAddress, tokenId, tokenImageUrl);
  ...
  const handleAssociateToProfile = async () => {
    ...
    try {
      ...
      const existingProfile = await ProfileService.getMyProfile(walletAddress);
      ...
      await ProfileService.addTokenToProfile(walletAddress, tokenData);
          ...
          <Card>
            <CardContent className="p-6">
              <div style={{ 
                ...
                {/* COLONNE DROITE - Boutons superposés */}
                <div style={{ 
                  display: 'flex', 
              ...
              {isCreator && (
                <div className="d-flex justify-between align-center mt-4 gap-3" style={{
                  paddingTop: '1rem',
      ...
      {showImportTokenModal && (
        <ImportTokenModal
          ...
          onSuccess={() => {
            ...
            setNotification({
              type: 'success',
              message: '✅ Jeton importé avec succès !'
            });
          }}
        />
      )}
