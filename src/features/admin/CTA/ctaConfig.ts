...
export const CTA_TYPES = {
  MY_ESTABLISHMENT: {
    ...
    showCondition: (userContext: { isCreator: boolean }) => !userContext.isCreator,
    getContent: (t: (arg0: string) => string) => ({
    ...
    onClick: (navigate: (arg0: string) => void) => navigate('/landing-page'),
  },
 ...
 * @param userContext - Contexte utilisateur (isCreator, etc.)
 * @returns Liste des types de CTA à afficher
 */
export const getActiveCTAs = (userContext: { isCreator: boolean }) => {
