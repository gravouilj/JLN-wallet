...
/** Interface pour les données du formulaire Certifications */
...
/** Props du composant CertificationsTab */
interface CertificationsTabProps {
  formData: CertificationsFormData;
 ...
 */
const CertificationsTab: React.FC<CertificationsTabProps> = ({ formData, handleChange, handleUrlBlur, openLink }) => {
  return (
    <Card>
