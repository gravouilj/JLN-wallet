 ...
 * 
 * @param {Object} props
 * @param {string} props.searchQuery - Valeur de la recherche
 * @param {Function} props.onSearchChange - Callback pour changement de recherche
 * @param {Array} props.filters - Configuration des filtres [{id, label, value, options, onChange, icon}]
 ...
 * @param {React.ReactNode} props.leftActions - Éléments à gauche de la recherche (ex: bouton favoris)
 * @param {string} props.searchPlaceholder - Placeholder de la recherche
 */
const SearchFilters = ({
  searchQuery = '',
  onSearchChange,
