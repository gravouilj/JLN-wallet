 ...
 * @param {string} actionType - Type d'action
 * @returns {string} - Variant du Badge
 */
 ...
 * @param {Object} props
 * @param {Object} props.entry - Entrée d'historique
 * @param {boolean} props.compact - Mode compact (moins de détails)
 */
 ...
 * @param {Object} props
 * @param {Array} props.history - Tableau d'entrées d'historique
 * @param {boolean} props.compact - Mode compact (affichage simplifié)
 */
export default function HistoryList({ history = [], compact = false }) {
